! function (s) {
    ...
    function n(e) {
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = "../images/us.jpg" : "Du" == e ? document.getElementById("header-lang-img").src = "../images/Flag_of_the_United_Arab_Emirates.svg.png" : "gr" == e ? document.getElementById("header-lang-img").src = "../images/germany.jpg" : "it" == e ? document.getElementById("header-lang-img").src = "../images/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = "../images/russia.jpg"), localStorage.setItem("language", e), null == (t = localStorage.getItem("language")) && n(a), s.getJSON("assets/lang/" + t + ".json", function (e) {
    ...
    function c(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("html").removeAttr("dir"), s("#dark-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), "~/css/bootstrap.min.css" != s("#bootstrap-style").attr("href") && s("#bootstrap-style").attr("href", "~/css/bootstrap.min.css"), s("html").attr("data-bs-theme", "light"), "~/css/app.min.css" != s("#app-style").attr("href") && s("#app-style").attr("href", "~/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("html").removeAttr("dir"), s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), s("html").attr("data-bs-theme", "dark"), "~/css/bootstrap.min.css" != s("#bootstrap-style").attr("href") && s("#bootstrap-style").attr("href", "~/css/bootstrap.min.css"), "~/css/app.min.css" != s("#app-style").attr("href") && s("#app-style").attr("href", "~/css/app.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e ? (s("#light-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), "~/css/bootstrap-rtl.min.css" != s("#bootstrap-style").attr("href") && s("#bootstrap-style").attr("href", "~/css/bootstrap-rtl.min.css"), "~/css/app-rtl.min.css" != s("#app-style").attr("href") && s("#app-style").attr("href", "~/css/app-rtl.min.css"), s("html").attr("dir", "rtl"), s("html").attr("data-bs-theme", "light"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 1 == s("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), "~/css/bootstrap-rtl.min.css" != s("#bootstrap-style").attr("href") && s("#bootstrap-style").attr("href", "~/css/bootstrap-rtl.min.css"), "~/css/app-rtl.min.css" != s("#app-style").attr("href") && s("#app-style").attr("href", "~/css/app-rtl.min.css"), s("html").attr("dir", "rtl"), s("html").attr("data-bs-theme", "dark"), sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"))
    }
    ...
    s("#side-menu").metisMenu(), s("#vertical-menu-btn").on("click", function (e) {
        ...
        }), null != t && t !== a && n(t), s(".language").on("click", function (e) {
